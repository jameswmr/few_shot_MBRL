...
class Pusher(SingleArmEnv):
    ...
    def __init__(
        ...
        self.default_plate1_pos = np.asarray([-0.075, 0.0, 0.8]) # sim
        self.default_plate2_pos = np.asarray([0.0, -0.075, 0.8]) # sim
        
        # self.default_plate1_pos = np.asarray([-0.15, 0.0, 0.8]) # real
        # self.default_plate2_pos = np.asarray([-0.075, -0.075, 0.8]) # real
