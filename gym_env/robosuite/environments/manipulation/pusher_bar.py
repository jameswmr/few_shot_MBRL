...
from robosuite.models.objects import BoxObject, RodBalanceObject
...
class Pusher_Bar(SingleArmEnv):
    ...
    def __init__(
        ...
        self.default_rodbalance_pos = np.asarray([0.0, 0.05, 0.8]) # real
        self.default_block_pos = np.asarray([0.1, -0.1, 0.8]) # real
        
        self.default_velocity_delay = 1.0
        ...
        self.default_black_pos_range = np.asarray([0.00, 0.00])
        ...
        self.block_init_pos = self.generate_positions(self.default_block_pos, self.default_black_pos_range)
    ...
    def _load_model(self):
        ...
        self.block = BoxObject(name="block", size=[0.101, 0.018, 0.018], rgba=[1, 0, 0, 0.5], obj_type="all", duplicate_collision_geoms=True)
        ...
        self.placement_initializer.append_sampler(
            sampler=UniformRandomSampler(
                ...
                x_range=[self.block_init_pos[0],self.block_init_pos[0]],
                y_range=[self.block_init_pos[1],self.block_init_pos[1]],
                rotation=1.57,
                rotation_axis='z',
        ...
        self.model = ManipulationTask(
            ...
            mujoco_objects=[self.block, self.rodbalance],
        )
    ...
    def _setup_references(self):
        ...
        self.block_body_id = self.sim.model.body_name2id(
            self.block.root_body)
    ...
    def _setup_observables(self):
        ...
        if self.use_object_obs:
            ...
            sensors = [block_pos, block_quat, rodbalance_pos, rodbalance_quat]
    ...
    def get_obs(self):
        ...
        block_pos = observation["block_pos"].flatten()
        block_quat = observation["block_quat"].flatten()
        
        rodbalance_pos = observation["rodbalance_pos"].flatten()
        rodbalance_quat = observation["rodbalance_quat"].flatten()
        
        obs = np.concatenate([
            block_pos, block_quat, rodbalance_pos, rodbalance_quat
        ])
    ...
    def reset(self):
        ...
        context["dynamic@rodbalance_g1@damping_ratio"] = -50
        context["dynamic@rodbalance_g0@damping_ratio"] = -50
