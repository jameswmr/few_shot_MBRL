...
class TableArena(Arena):
    ...
    def configure_location(self):
        ...
        # self.table_collision.set("solref", array_to_string([0.01, 0.105]))
        self.table_collision.set("solref", array_to_string([0.02, 1])) # 0.04
        # print ("table_arena.py,60",self.table_collision)
