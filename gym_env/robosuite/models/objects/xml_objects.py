...
class RodBalanceObject(MujocoXMLObject):
    """_summary_

    Args:
        MujocoXMLObject (_type_): _description_
    ...
    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/rod_balance.xml"),
            name=name,
...
class KnobObject(MujocoXMLObject):
    """
    Knob object
    """
    ...
    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/knob.xml"),
            name=name,
            joints=[dict(type="free", damping="0.0005")],
            obj_type="all",
            duplicate_collision_geoms=True,
...
class Plate1Object(MujocoXMLObject):
    """
    Plate 1
    """
    ...
    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/plate1.xml"),
            name=name,
            joints=[dict(type="free", damping="0.0005")],
            obj_type="all",
            duplicate_collision_geoms=True,
...
class Plate2Object(MujocoXMLObject):
    """
    Plate 2
    """
    ...
    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/plate2.xml"),
            name=name,
            joints=[dict(type="free", damping="0.0005")],
            obj_type="all",
            duplicate_collision_geoms=True,
...
class RoundConer(MujocoXMLObject):
    """
    Plate 2
    """
    ...
    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/round_coner.xml"),
            name=name,
            joints=[dict(type="free", damping="0.0005")],
            obj_type="all",
            duplicate_collision_geoms=True,
...
class SpatulaObject(MujocoXMLObject):
    ...
    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/spatula.xml"),
            name=name,
            obj_type="visual",
            joints=None,
            duplicate_collision_geoms=True,
...
class StepStoneObject(MujocoXMLObject):
    """
    Milk carton object (used in PickPlace)
    """
    ...
    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/step_stone.xml"),
            name=name,
            joints=[],
            obj_type="all",
            duplicate_collision_geoms=True,
...
class StepStone2Object(MujocoXMLObject):
    """
    Milk carton object (used in PickPlace)
    """
    ...
    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/step_stone_2.xml"),
            name=name,
            joints=[],
            obj_type="all",
            duplicate_collision_geoms=True,
...
class X_Right_Wall_Object(MujocoXMLObject):
    """
    Milk carton object (used in PickPlace)
    """
    ...
    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/x-right-wall.xml"),
            name=name,
            joints=[],
            obj_type="all",
            duplicate_collision_geoms=True,
...
class Floor_1_object(MujocoXMLObject):
    """
    Milk carton object (used in pusherone)
    """

    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/floor_1.xml"),
            name=name,
            joints=[],
            obj_type="all",
            duplicate_collision_geoms=True,
...
class Floor_2_object(MujocoXMLObject):
    """
    Milk carton object (used in pusherone)
    """
    ...
    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/floor_2.xml"),
            name=name,
            joints=[],
            obj_type="all",
            duplicate_collision_geoms=True,
...
class Block(MujocoXMLObject):
    ...
    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/block.xml"),
            name=name,
            joints=[],
            obj_type="all",
            duplicate_collision_geoms=True,
...
class Cube(MujocoXMLObject):
    """
    Cube object (used in pose_changer)
    """
...
class CubeVisual(MujocoXMLObject):
    """
    Cube object (used in pose_changer)
    """
...
class X_Left_Wall_Object(MujocoXMLObject):
    """
    Milk carton object (used in PickPlace)
    """
    ...
    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/x-left-wall.xml"),
            name=name,
            joints=[],
            obj_type="all",
            duplicate_collision_geoms=True,
...
class Y_Front_Wall_Object(MujocoXMLObject):
    """
    Milk carton object (used in PickPlace)
    """
    ...
    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/y-front-wall.xml"),
            name=name,
            joints=[],
            obj_type="all",
            duplicate_collision_geoms=True,
...
class Y_Back_Wall_Object(MujocoXMLObject):
    """
    Milk carton object (used in PickPlace)
    """
    ...
    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/y-back-wall.xml"),
            name=name,
            joints=[],
            obj_type="all",
            duplicate_collision_geoms=True,
