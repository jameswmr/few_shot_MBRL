...
class SingleArm(Manipulator):
    ...
    def control(self, action, policy_step=False):
        # print ("action4control", action)
        # print ("policy_step", policy_step)
        """
        ...
        # print ("self.ee_pos", self.controller.ee_pos)
        tem_pos = self.controller.ee_pos
        torques = self.controller.run_controller()
        # self.controller.ee_pos = tem_pos
        # print ("self.ee_pos_______", self.controller.ee_pos)
